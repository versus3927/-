...
Вы загружаете на личный Discord-сервер один или несколько скриншотов одного матча. Бот бесплатно распознаёт их через Gemini API Free Tier и возвращает готовое сообщение для копирования на сервер регистрации.
...
Отправьте скриншот результата в указанный канал. Можно приложить до четырёх изображений одного матча одним сообщением. Например:
